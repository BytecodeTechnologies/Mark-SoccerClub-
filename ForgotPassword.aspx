<%@ Page Title="" Language="C#" MasterPageFile="~/OuterMasterPage.master" AutoEventWireup="true" CodeFile="ForgotPassword.aspx.cs" Inherits="ForgotPassword" %>
             ...
             <label>
                        ...
                        <asp:TextBox ID="tbUserLogInId" runat="server" TextMode="SingleLine" ControlToValidate="tbUserLogInId"
                           ...
                           &nbsp;<asp:Button Height="24px" ID="btnSumbit" runat="server" Text="Submit" ValidationGroup="g" 
                            ...
                            <asp:RequiredFieldValidator ID="rqv" runat="server" ControlToValidate="tbUserLogInId" ErrorMessage="Email ID required." ValidationGroup="g"></asp:RequiredFieldValidator>
