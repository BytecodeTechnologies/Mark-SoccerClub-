<%@ Page Title="" Language="C#" MasterPageFile="~/OuterMasterPage.master" AutoEventWireup="true" CodeFile="soccerVSfootball.aspx.cs" Inherits="soccer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

 <table style="margin:8px" border="0" cellpadding="0" cellspacing="0" width="98%">
 <tr>
 <td>
 ...
 <p>
 So, while players in North America toil away in the professional league known as MLS (Major League Soccer), players in Europe vie for the coveted UEFA (Union of European Football Associations) Championship. 
 </p>
 <p>
 But, wherever you live, or wherever you play, and whatever name you use for the sport, it’s still known worldwide as the most beautiful game on earth.
 </p>
