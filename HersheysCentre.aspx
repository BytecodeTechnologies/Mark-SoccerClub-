...
<asp:Content ID="mainContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="padding-left: 50px">
        ...
        <i>
            <h2>Player Registration for HERSHEY CENTRE</h2>
        </i>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top">
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbRegPhoneNumber" runat="server" TextMode="SingleLine" Width="150px" />
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:ImageButton ID="btnRegSubmit" Style="margin-top: 6px" runat="server" ImageUrl="http://www.canadiansoccerclub.com/Images/register.png"
                ...
                <td valign="top">
                    <h3>List of Registered Players for Hershey Centre</h3>
